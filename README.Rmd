...
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#experimental) [![CRAN status](https://www.r-pkg.org/badges/version/crownsegmentr)](https://CRAN.R-project.org/package=crownsegmentr)
...
Currently, only `segment_tree_crowns` works with all three input data types. The 
other function work only for LAS, but have the other methods as dummies for
future expansion.
...
<a name="ferraz2016"></a> Ferraz, A.; Saatchi, S.; Mallet, C. & Meyer, V., "Lidar detection of individual tree size in tropical forests"", In: *Remote Sensing of Environment*, Elsevier BV, 2016, 183, 318-333, DOI: [10.1016/j.rse.2016.05.028](https://doi.org/10.1016/j.rse.2016.05.028)
